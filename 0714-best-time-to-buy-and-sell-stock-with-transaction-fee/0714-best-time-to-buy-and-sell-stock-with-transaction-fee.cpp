...
//                 else // buy==0, Already bought now its time to sell
//                 {
//                     maxProfit = max(prices[idx] - fee + dp[idx+1][1],dp[idx+1][0]); // 1st instance is of selling which leads to buy=1 since you are allowed to buy after selling while 2nd instance is of continuing to other day without selling the stock in order to look for better profit.
//                 }
